...
export const user = pgTable("user", {
	...
	role: text("role", { enum: ["admin", "student", "company"] }).notNull(),
...
export const studentLanguages = pgTable(
	...
	(table) => [primaryKey({ columns: [table.indexNumber, table.language] })],
);
...
export const studentPhysicalPermitRelations = relations(
	studentPhysicalPermit,
	({ one }) => ({
		student: one(student, {
...
export const studentChildCareRelations = relations(
	studentChildCare,
	({ one }) => ({
		student: one(student, {
...
export const studentTranslatorRelations = relations(
	studentTranslator,
	({ one, many }) => ({
		student: one(student, {
